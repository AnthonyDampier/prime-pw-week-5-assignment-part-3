...
// Created 8 albums in collection array
...
function showCollection(){
    ...
    for (album of collection){
        ...
        // Prints all tracks; if tracks exist.
    ...
    if  (trackName !== undefined){
        ...
        for (let i = 0; i < collection.length; i++){
            ...
            if (collection[i].artist.toUpperCase() === artist.toUpperCase() && collection[i].yearPublished === year){
                ...
                // track was not found in albums; add track to album on confirmation
                if (confirm('Do you want to add missing track?')){
                    console.log(trackName, "was added to album on confirmation");
                    // console.log(collection[i]);
...
console.log('Expect to output [] (NOT FOUND): ', search("Artist1", "2021", 'track3'));
console.log('Expect track found in title4: ', search("Artist4", "2021", 'track2'));

console.log('*** Y/N : add track to album ***');
console.log('Expect to out title1 (OK) or [] (Cancel): ', search("Artist1", "2021", 'track3'));
